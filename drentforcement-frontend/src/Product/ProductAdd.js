        ...
        if (provider) {
          ...
          if (provider !== window.ethereum) {
            ...
            try {
              ...
              try {
                var result = await rentforcementContract.methods
                  .checkIfUserExists()
                  .call();
              ...
              if (isAuth) {
                ...
                try {
                  var fetchedUserProfile = await rentforcementContract.methods
                    .fetchUserProfle()
                    .call();
  ...
  const addNewProduct = async () => {
    ...
    if (rentforcementContract) {
      try {
        ...
        var productAdded = await rentforcementContract.methods
          .addProductOnRent(
            productName,
            productDesc,
            numOfDays,
  ...
  const ProductForm = (
    <React.Fragment>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
          {/* <div style={{ paddingTop: '0.5cm' }}>Choose an image of product</div> */}
          <Typography variant='body1' style={{ paddingTop: '0.5cm' }} >Choose an image of product</Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
    ...
    if (isValid) {
            ...
            <React.Fragment>
              <main className={`${classes.layout}`}>
                <Paper className={classes.paper}>
                  ...
                  <React.Fragment>
                    <div style={{ paddingTop: '1cm' }}>{ProductForm}</div>
                  </React.Fragment>
                </Paper>
              </main>
            </React.Fragment>
      ...
      return (
        <div className="Dashboard">
          <h3>
            Multiple wallets are installed! This dapp is only compatible with
            Metamask!
          </h3>
        </div>
      );
